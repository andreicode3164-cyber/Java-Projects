...
public class CircumferenceCircle {
    public static void main(String[] args) {
        ...
        System.out.println("Welcome to my Circumference of the circle Calculator!");
        try { //Catch the wrong data type input error, specifically double.
            do {
                ...
                System.out.print("\nDo you still want to continue(YES or NO)?: "); // Ask if the user want to continue, or stop.
                askUser = scan.next();
